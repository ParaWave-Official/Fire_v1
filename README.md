...
> _Link not yet available — will be added once the folder is shared._
...
| **Fire_Distance** | _Proprietary / no public source_ |

---

*Report generated by `generate_report.py` for benchmark **Fire_v1**.*
